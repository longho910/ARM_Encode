...
public class Model {
    ...
    public void armToBinaryAndHex(String arm) {
        ...
        try {
            ...
            c.feedback.setText("Illegal ARM, please retry.");
    ...
    public void binaryToArmAndHex(String binary) {
        ...
        if (binary.length() != 32) {
            c.feedback.setText("Illegal binary number, please retry.");
        }
        ...
        try {
            ...
            System.out.println("Illegal binary number, please retry.");
        }
    ...
    public void hexToBinaryAndARM(String hexString) {
        ...
        if (hexString.length() != 8) {
            c.feedback.setText("Illegal hex number, please retry.");
        }
        // hex to int
